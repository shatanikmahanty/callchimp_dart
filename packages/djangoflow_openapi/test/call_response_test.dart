...
// tests for CallResponse
void main() {
  final CallResponse? instance = /* CallResponse(...) */ null;
  ...
  group(CallResponse, () {
    ...
    // int dialCount
    test('to test the property `dialCount`', () async {
      // TODO
    });
    ...
    // String disposition
    test('to test the property `disposition`', () async {
      // TODO
    });
    ...
    // Lead foreign key
    // int lead
    test('to test the property `lead`', () async {
      // TODO
    });
    ...
    test('to test the property `recordingPath`', () async {
      // TODO
    });
