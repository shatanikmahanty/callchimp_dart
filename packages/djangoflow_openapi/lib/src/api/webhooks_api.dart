...
class WebhooksApi {
  ...
  Future<Response<void>> webhooksDelete({
    required int id,
  ...
  Future<Response<WebhookResponse>> webhooksGet({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<WebhookResponse, WebhookResponse>(rawData, 'WebhookResponse', growable: true);
  ...
  Future<Response<WebhookListResponse>> webhooksList({
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<WebhookListResponse, WebhookListResponse>(rawData, 'WebhookListResponse', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
  ...
  /// Returns a [Future] containing a [Response] with a [WebhookResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WebhookResponse>> webhooksPost({
  ...
  /// Returns a [Future] containing a [Response] with a [WebhookResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<WebhookResponse>> webhooksUpdate({
    required int id,
    required WebhookRequest webhookRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
