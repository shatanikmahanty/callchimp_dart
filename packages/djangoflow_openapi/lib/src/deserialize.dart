...
import 'package:callchimp_dart/src/model/model4_xx_response.dart';
...
import 'package:callchimp_dart/src/model/transaction_call_request_by_lead_id.dart';
...
ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable = true}) {
  switch (targetType) {
    ...
    case 'CallsPostRequest':
      return CallsPostRequest.fromJson(value as Map<String, dynamic>) as ReturnType;
    ...
    case 'Model4XXResponse':
      return Model4XXResponse.fromJson(value as Map<String, dynamic>) as ReturnType;
    case 'Model4XXResponseErrorsInner':
      return Model4XXResponseErrorsInner.fromJson(value as Map<String, dynamic>) as ReturnType;
    ...
    case 'TransactionCallRequestByLeadId':
      return TransactionCallRequestByLeadId.fromJson(value as Map<String, dynamic>) as ReturnType;
