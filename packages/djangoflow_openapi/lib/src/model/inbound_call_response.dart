...
class InboundCallResponse {
  ...
  @JsonKey(name: r'callchimp_number', required: false, includeIfNull: false)
  final InboundCallResponseCallchimpNumber? callchimpNumber;

  @JsonKey(name: r'created_at', required: false, includeIfNull: false)
  final DateTime? createdAt;

  @JsonKey(name: r'dial_status', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'hangup_cause', required: false, includeIfNull: false)
  final InboundCallResponseHangupCause? hangupCause;

  @JsonKey(name: r'id', required: false, includeIfNull: false)
  final int? id;

  @JsonKey(name: r'inbound_caller', required: false, includeIfNull: false)
  final String? inboundCaller;

  @JsonKey(name: r'is_answered', required: false, includeIfNull: false)
  final bool? isAnswered;

  @JsonKey(name: r'organization', required: false, includeIfNull: false)
  final int? organization;

  @JsonKey(name: r'supervisor', required: false, includeIfNull: false)
  final InboundCallResponseSupervisor? supervisor;

  @JsonKey(name: r'supervisor_number', required: false, includeIfNull: false)
  final InboundCallResponseHangupCause? supervisorNumber;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is InboundCallResponse &&
